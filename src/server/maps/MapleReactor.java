            ...
            if (hitLock.tryLock()) {
                ...
                try {
                    ...
                    if (YamlConfig.config.server.USE_DEBUG == true) {
                        c.getPlayer().dropMessage(5, "被击中的反应堆id： " + this.getId() + " with POS " + charPos + " , STANCE " + stance + " , SkillID " + skillid + " , STATE " + stats.getType(state) + " STATESIZE " + stats.getStateSize(state));
                    }
