    ...
    public void execute(MapleClient c, String[] params) {
        ...
        if (params.length > 0) {
            ...
            if (victim != null) {
                ...
                Server.getInstance().broadcastGMMessage(c.getWorld(), MaplePacketCreator.serverNotice(5, player.getName() + "在" + victim.getName() + "使用了!bomb"));
            } else {
                player.message("玩家'" + params[0] + "'在这个服务器上找不到.");
            }
        } else {
